...
const StatCard = ({ title, value, icon, description }: { title: string; value: number; icon: React.ReactNode; description: string }) => {
    return (
        <Card className="border-slate-200/60 shadow-xl shadow-slate-100/40 hover:shadow-2xl hover:shadow-slate-200 transition-all rounded-3xl group overflow-hidden bg-white">
